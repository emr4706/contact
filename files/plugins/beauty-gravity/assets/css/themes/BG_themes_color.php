...
form:not(.bg_default_theme) .ginput_container li:not(.image-choices-choice), .gform_wrapper form:not(.bg_default_theme) .main_label {
    display: flex;
    align-items: center
}
...
.BG_Microsoft .BG_Button li:not(.image-choices-choice) label:hover ~ .gf_tooltip_body > i {
    color: #fff !important;
    transition: none;
...
#gform_[form_id].BG_Microsoft .BG_Button li:not(.image-choices-choice) label:hover {
    background: var(--microsoft-color-primary) !important;
    color: #fff !important;
    border-color: var(--microsoft-color-primary) !important;
}

#gform_[form_id].BG_Microsoft .BG_Button li:not(.image-choices-choice) input[type='checkbox']:checked ~ label, #gform_[form_id].BG_Microsoft .BG_Button li:not(.image-choices-choice) input[type='radio']:checked ~ label {
    background: var(--microsoft-color-primary) !important;
    color: #fff !important;
    border-color: var(--microsoft-color-primary) !important
}
