    ...
    <div class="uk-child-width-1-2@m uk-child-width-1-1 uk-text-center" id="pricingrid" uk-grid>
      <div>
        <div class="uk-card uk-card-default uk-margin-medium uk-card-body uspPricing rounded">
         ...
         <div class="uk-container titlePricingCard uk-margin-top" >
          ...
          <button class="uk-button uk-button-default uk-width-1-1 uk-margin-small-bottom uk-margin-small-top btn-business" href="<?php echo e(home_url('/')); ?>registreren?source=<?php echo get_permalink(); ?>" >AANMELDEN</button>
      ...
      <div>
        <div class="uk-card uk-card-default uk-margin-medium uk-card-body uspPricing rounded" id="uspPricing2">
          ...
          <button class="uk-button uk-button-default uk-width-1-1 uk-margin-small-bottom uk-margin-small-top btn-someone" href="<?php echo e(home_url('/')); ?>registreren?source=<?php echo get_permalink(); ?>" >AANMELDEN</button>
...
?>
<section class="uk-section uk-margin-large-bottom rounded">
  <div class="uk-container">
    <div>
      <div class="uk-text-center">
        <div class="rgs-text"><?php echo $title ?><br><img data-src="<?= App\asset_path('images/arrov_black.png'); ?>" alt="" uk-img /><br></div>
      ...
      <tbody class="dataContainer ">
          <tr id="tableData">
            <?php if ($comingSoon == "ja") : ?>
              <td class="dataNaamSoon"><img data-src="<?= App\asset_path('images/coming-soon-features.png'); ?>" uk-img alt=""><span>Coming soon!</span> <p id="soon"><?php echo $fetuareNaam ?></p></td>
              <?php else: ?>
  ...
  <div class="uk-position-absolute background-top" style="background-image: url(<?= App\asset_path('images/background-top.png'); ?>);"></div>
	...
	<div class="uk-container content uk-margin-large-bottom">
		...
		<div class="uk-position-relative">
			...
			<img data-src="<?= App\asset_path('images/testimonials-telefoon.png'); ?>" uk-img />
		</div>
	</div>
</section>
...
$link = get_sub_field('link');
?>
<section class="uk-section gradient register rounded">
  <div class="uk-container">
    <div class="uk-child-width-expand@s uk-child-width-1-1" uk-grid>
     
      <div class="uk-flex uk-flex-middle uk-text-center">
        <div class="cta-text"><?php echo $title ?><br><img data-src="<?= App\asset_path('images/arrov_meer.png'); ?>" alt="" uk-img /><br><a class="uk-button btn-cta uk-margin-small-top" href="<?php echo e(home_url('/')); ?>registreren?source=<?php echo get_permalink(); ?>">Call 2 action</a></div>
      </div>
      <?php endif; ?>
      ...
      <?php if (get_row_layout() == 'register') :
      $title = get_sub_field('title');
      ...
      <div>
        ...
        <p class="uk-margin-small-top"><?php echo $text ?></p>
        <div class="uk-container formContainer" id="registerHomeForm">
          <?php echo $form ?>
        </div>
      </div>
      <?php endif; ?>
