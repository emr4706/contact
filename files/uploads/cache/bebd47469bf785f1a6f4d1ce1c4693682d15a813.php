...
<section class="uk-section integrations gradient rounded">
    ...
    <p class="uk-margin-large-bottom" ><?php echo $text ?></p>
     ...
     <ul id="datalist" class="datalist">
      ...
      <div class="uk-text-center uk-margin-large-bottom" id="melding" ><a href="" id="span" class="loadmore">Laad meer integraties <br> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path d="M12 21l-12-18h24z" fill="#fff"/></svg></a> </div>
  </div>
</section>
<?php endif; ?>
