      ...
      <?php foreach ($list as $item) :
			...
			?>
				<li>
					<div class="uk-flex">
            <div class="i">
              <i class="icon icon-align icon-usp icon-24"></i>
            </div>
            <div class="text123">
              <h3>
                <?php echo $title; ?>
		...
		<div uk-slider="uk-slider">
            ...
            <li>
              ...
              <?php endforeach; ?>
					...
					<a class="uk-position-center-left-out uk-position-small" style="text-decoration: none; visibility: visible !important;"; href="#"  uk-slider-item="previous">
            <i class="icon icon-align icon-bullet-left icon-40"></i>
          </a>
          </a>
          <a class="uk-position-center-right-out uk-position-small" style="text-decoration: none; visibility: visible !important;"; href="#" uk-slider-item="next">
            <i class="icon icon-align icon-bullet-right icon-40"></i>
          </a>
			</div>
			<ul class="uk-slider-nav uk-dotnav uk-flex-center uk-margin-large-top uk-margin-large-bottom" style="display: flex !important; visibility: visible !important;"></ul>
		</div>
	</div>
</section>
<?php endif; ?>
